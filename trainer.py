...
def trainer_synapse(args, model, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            #image_batch, label_batch = image_batch, label_batch.squeeze(1)
            '''
            ################################# TIMER HERE ##################################################################
            times = []
            for i in range(200):
            ...
            print(f' TIMESSSSS  : {sum(times) / len(times)}')
            times = []

            ################################################################################################################
            '''
            ################################################################################################################################################################
            #print(f' IMAAAAGEE BAAAATCCHH SHAPE : {image_batch.shape}')
            ...
            #print(f' OOOUUUTTPPPUUUUTTTT SHAPE : {outputs.shape}')
