...
def trainer_synapse(args, model, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        print(f'#'*100)
        print(f'HERE END PRUNNING LOOP')
        print(f'#'*100)
        ...
        exporter.export_pytorch(name="Embedded_ViT_64-pruned.pth")
        exporter.export_onnx(torch.randn(1, 1, 64, 64), name="Embedded_ViT_64-pruned.onnx", convert_qat=True)
