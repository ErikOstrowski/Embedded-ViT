...
parser.add_argument("--input_model", type=str, help="path_to_pretrained_model")
...
if __name__ == "__main__":
    ...
    ############################################################################################################################################################
    args.num_classes =  dataset_config[dataset_name]["num_classes"] # 5
    ...
    if args.input_model:
    	snapshot = os.path.join(args.input_model)
