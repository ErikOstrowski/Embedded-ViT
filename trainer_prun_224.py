...
def trainer_synapse(args, model, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        exporter.export_pytorch(name="Embedded_ViT_224-pruned.pth")
        exporter.export_onnx(torch.randn(1, 1, 224, 224), name="Embedded_ViT_224-pruned.onnx", convert_qat=True)
